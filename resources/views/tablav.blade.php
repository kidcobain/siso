...
var filadesplegable = `
    ...
    $('.agregarlotedesplegable').click(function(event) {
       ...
       var aq = $('.desplegable').after($filadesplegable);
       var hour = showTime();
       console.log($filadesplegable);
       console.log($filadesplegable.find('.hora'));
       ...
       if ($('.datosdesplegable')) {
        ...
        $('.desplegable > td').append(filadesplegable);
       }
    ...
    var editarLote = function () {
       ...
       var vacio = "";
       //valores[1] = "G95";
       //var selected = (valores[1])?'selected':'';
       /*
       var inputslote = '<input class="editando" type="text" size="3" maxlength="3" value="'+valores[0]+'"/> - \
                            <select name="tipo">\
                                <option value="">tipo </option>\
                                <option value="G95" '+ (valores[1] == "G95")? selected : vacio +'>G95</option>\
                                <option value="G91">G91</option>\
                                <option value="DSL">DSL</option>\
                            </select>';
                            console.log(inputslote);
        */

        var inputslote = `<input class="editando" type="text" size="3" maxlength="3" value="${valores[0]}"/> - 
                            <select name="tipo" class="selectipo">
                                <option value="">tipo </option>
                                <option value="G95" ${ (valores[1] == "G95")? seleccionado : vacio }>G95</option>
                                <option value="G91" ${ (valores[1] == "G91")? seleccionado : vacio }>G91</option>
                                <option value="DSL" ${ (valores[1] == "DSL")? seleccionado : vacio }>DSL</option>
                            </select>`;
        ...
        //var $select = $(this).find('.selectipo');
...
// los numeros de lotes son consecutivos?
// los lotes van ordenados por numero y hora?
                        </script>
@endsection